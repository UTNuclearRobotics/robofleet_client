...
namespace std_srvs_robofleet {
  ...
  class TriggerRequestPublishHandler : public robofleet_client::ROSPublishHandler
  {
  public:
  ...
  private:
    typedef std_srvs::TriggerRequest MsgType;
  ...
  class TriggerRequestSubscribeHandler : public robofleet_client::ROSSubscribeHandler
  {
  public:
