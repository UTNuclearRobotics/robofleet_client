...
namespace std_srvs_robofleet {
  ...
  class EmptyRequestPublishHandler : public robofleet_client::ROSPublishHandler
  {
  public:
  ...
  private:
    typedef std_srvs::EmptyRequest MsgType;
  ...
  class EmptyRequestSubscribeHandler : public robofleet_client::ROSSubscribeHandler
  {
  public:
