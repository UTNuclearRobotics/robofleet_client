...
"""
Module taken from: https://github.com/ut-amrl/robofleet/blob/master/msg2fbs/msg_util.py
Original author: Logan Zartman
"""
...
def get_msg_spec(msg_type_name, search_path):
...
def get_srv_spec(srv_type_name, search_path):
    """ Get ROS MsgSpec for given message type """
    context = genmsg.MsgContext.create_default()
    search_path = get_msg_search_path()
